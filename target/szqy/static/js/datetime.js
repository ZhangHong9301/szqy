(function(){
	var d=document,
		...
		ids=null,
		oInput=null;
	document.write('<iframe frameborder=0 style="display:none;position:absolute;" width="173" height="215" scrolling="no" name="sangcalender" id="sangcalender"></iframe>');
